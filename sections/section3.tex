...
\end{figure}
Liners should have the same dimensions and the same acoustic properties. However, no-negligible differences between these liners are highlighted:
\begin{figure}[H] \centering
